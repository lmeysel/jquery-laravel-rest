...
jQuery.rest = (function($) {
	...
	function e(sender) {
		 var cont = $('<div>').appendTo($('body'))
			  .css({'width': '100%', 'height': '100%', 'position': 'fixed', 'top': 0, 'left': '0', 'background-color': '#ffc8c8'});
		 ...
		 var iframe = $('<iframe>').appendTo(cont)
			  .css({'position': 'absolute', 'top':text.outerHeight() + 20+'px', width: '100%', 'border': '1px solid #red',
